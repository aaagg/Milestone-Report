...
========================================================
author: Aashima Aggarwal
date: Wed Oct 30 15:13:12 2019
...
*[Shiny App]* - [https://aashima.shinyapps.io/Predict]

*[Github Repo]* - [https://github.com/aaagg/Milestone-Report]
...
<span style="color:blue; font-weight:bold;font-size:0.7em">A Shiny application was developed based on the next word prediction model described previously as shown below. </span><img src="image.png"></img>
